...
| [GitHelper](GitHelper/) | [setup.sh](GitHelper/setup.sh) | Interactive and automated setup for Git and GitHub. Configures git username and email, generates an SSH key, starts ssh-agent, adds the key, and uploads it to GitHub using a Personal Access Token. |
